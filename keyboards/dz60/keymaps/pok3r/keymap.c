...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		_______, KC_MPRV, KC_MPLY, KC_MNXT, RESET, _______, _______, KC_PGDN, KC_UP, KC_PGUP, KC_PSCR, KC_SLCK, KC_PAUS, _______,
		_______, _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_INS, KC_DEL, KC_NUBS,
	...
	LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, _______, EQ, RCROCO, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, LCBRACK, LPARAN, RPARAN, RCBRACK, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, LCROCO, LHBRACK, RHBRACK, RCROCO, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
};
